...
import ru.vvsem.bank.analyzer.dto.DashboardStats;
...
//        stats.setActiveBudgets(activeBudcasts != null ? activeBudgets : 0L);
//
...
//        return transactionRepository.findTopNByUserIdOrderByOperationTimeDesc(userId, limit);
//    }
}